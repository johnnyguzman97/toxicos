...
$query = "SELECT * FROM products WHERE category LIKE 'new arrivals'";
...
<head>
    ...
    <title>New Arrivals - ToxicWear</title>
    ...
    <div class="product-grid">
        <?php while ($product = $result->fetch_assoc()): ?>
            <div class="product-card">
                ...
                <a href="cart.php?id=<?= $product['id'] ?>" class="add-to-cart" style="background-color: #ff4d4d; color: white; padding: 8px 16px; border-radius: 4px; text-decoration: none;">Add to Cart</a>
            </div>
        <?php endwhile; ?>
    </div>
</section>
