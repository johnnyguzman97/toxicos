...
// Fetch Popular T-Shirts Products from Database
$query = "SELECT * FROM products WHERE category LIKE '%Popular T-Shirts%'";
...
<head>
    ...
    <title>Popular T-Shirts - ToxicWear</title>
...
<!-- Hero Section for Popular T-Shirts -->
<section class="hero-section">
    <div class="hero-overlay">
        <h1>Popular T-Shirts</h1>
        <p>Our Top-selling T-Shirts.</p>
    </div>
</section>

<!-- Product Display Section -->
<section class="product-display">
    <h2 class="section-title">Popular T-Shirts Collection</h2>
